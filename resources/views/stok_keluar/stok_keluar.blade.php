...
@section('content')
    <div class="container-fluid">
        <h4 class="mb-3">Daftar Stok Barang Keluar</h4>
        <nav aria-label="breadcrumb" class="mb-1">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Daftar Stok Barang Keluar</li>
            </ol>
        </nav>
                ...
                <div class="mt-3 card">
                    <div class="card-header">
                        <div class="d-flex">
                            <div class="pt-1 w-100">
                                <strong>Daftar Stok Barang Keluar</strong>
                            </div>
                            <div class="w-100 text-end">
                                <a href="{{ route('/stok_keluar') }}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mx-3 my-4 row">
                            <div class="col-6">
                                <a href="{{ route('stok_keluar.create') }}" class="btn btn-primary btn-sm">Tambah Stok<i class="fa-solid fa-plus"></i></a>
                            </div>
                            <div class="col-6">
                                <form action="{{ route('/stok_keluar') }}" method="GET">
